...
public abstract class Mesh {
	...
	abstract void setScale(Vector3f s);

	abstract void setTranslate(Vector3f t);

	abstract void setRotate(Vector3f h, Vector3f a);

	abstract void setRotateAngle(Vector3f a);
	abstract Matrix4f getpTransform();
